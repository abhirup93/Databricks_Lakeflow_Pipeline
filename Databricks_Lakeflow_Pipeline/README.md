...
The 'Databricks_Lakeflow_Pipeline' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/Databricks_Lakeflow_Pipeline/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] Databricks_Lakeflow_Pipeline_etl` to your workspace.
